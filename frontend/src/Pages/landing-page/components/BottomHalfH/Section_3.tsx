...
function Section_3() {
  return (
    <div className="bg-yellow-50">
      <section id="menus" className="justify-between gap-8 md:flex pt-4 mb-14">
        <div className="mt-5 ml-20 mr-20 justify-between md:flex">
        <div className="relative basis-1/5">
        {/* FISRT-SECTION */}
        <div className="relative w-2/6 basis-1/5">
          <HeaderText>HealthHero</HeaderText>
        </div>
        </div>

        <div className="relative w-2/6 basis-3/5">
        {/* CENTER-SECTION */}
        <div className="mt-5">
        ...
        <div className="flex w-2/6 basis-1/5">
          {/* SECOND-SECTION */}
          <p className="font-bold">MENU ITEM 6</p>
          <p>Vel nesciunt quia molestiae tempore qui nobis harum tempore qui nobis harum.</p>
        </div>
        </div>
        </div>
      </section>
